...
import org.openqa.selenium.support.ui.Select;
    ...
    public class MyFirstSeleniumTest {
        ...
        public void testSelenium() throws Exception {
            ...
            assertTrue(isElementPresent(By.id("show-settings-link")));
            assertTrue(isElementPresent(By.id("contextual-help-link")));
            assertTrue(isElementPresent(By.linkText("Utwórz wpis")));
